...
<template>
    <div class="fw-bold text-center h2 mt-2">
        <RouterLink to="/mypage" class="text-decoration-none text-dark">
            Picket
        </RouterLink>
    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div v-if="passwordChangeStep === 1">
                    <input type="email" v-model="emailForPasswordChange" placeholder="이메일 주소" class="input-field"
                        disabled />
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div v-if="phoneChangeStep === 2">
                    ...
                    <button v-if="phoneVerificationMessage === '인증 완료.'" @click="updatePhoneNumber"
                        class="action-button">휴대폰 번호 재설정</button>
                </div>
            </div>
            <div class="modal-actions">
